...
void OLED_I2C_SSD1309::drawLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1, uint16_t color){
	Adafruit_GFX::drawLine(x0, y0, x1, y1, color);
}

void OLED_I2C_SSD1309::drawRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color){
	Adafruit_GFX::drawRect(x, y, w, h, color);
}
void OLED_I2C_SSD1309::fillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color){
	Adafruit_GFX::fillRect(x, y, w, h, color);
}

void OLED_I2C_SSD1309::drawCircle(int16_t x, int16_t y, int16_t r, uint16_t color) {
    Adafruit_GFX::drawCircle(x, y, r, color);
}
void OLED_I2C_SSD1309::fillCircle(int16_t x, int16_t y, int16_t r, uint16_t color) {
    Adafruit_GFX::fillCircle(x, y, r, color);
}
void OLED_I2C_SSD1309::drawTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2,int16_t y2, uint16_t color) {
    Adafruit_GFX::drawTriangle(x0, y0, x1, y1, x2, y2, color);
}
void OLED_I2C_SSD1309::fillTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2,int16_t y2, uint16_t color) {
    Adafruit_GFX::fillTriangle(x0, y0, x1, y1, x2, y2, color);
}
void OLED_I2C_SSD1309::fillScreen(uint16_t color){
